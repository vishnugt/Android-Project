  ...
  implements Parcelable
{
  ...
  public BackStackState(a parama)
  {
    ...
    if (localb2 != null)
    {
      ...
      int i5;
      int i7;
      for (int i1 = localb2.d.mIndex;; i1 = -1)
      {
        arrayOfInt2[m] = i1;
        ...
        while (i8 < i6)
        {
          ...
          int i9 = i7 + 1;
          arrayOfInt9[i7] = ((Fragment)localb2.i.get(i8)).mIndex;
          i8++;
          i7 = i9;
        }
      }
  ...
  public final a a(j paramj)
  {
    ...
    while (j < this.a.length)
    {
      ...
      int n = arrayOfInt2[k];
      if (n >= 0) {}
      for (localb.d = ((Fragment)paramj.f.get(n));; localb.d = null)
      {
        int[] arrayOfInt3 = this.a;
        int i1 = m + 1;
        ...
        while (i6 < i5)
        {
          ...
          ArrayList localArrayList = paramj.f;
          int[] arrayOfInt8 = this.a;
          int i7 = j + 1;
