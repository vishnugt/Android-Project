...
class UrlRedirectCache
{
  ...
  static void cacheUriRedirect(Context paramContext, java.net.URI paramURI1, java.net.URI paramURI2)
  {
    ...
    //   0	82	1	paramURI1	java.net.URI
    //   0	82	2	paramURI2	java.net.URI
    //   10	63	3	localObject1	Object
    //   53	6	4	localObject2	Object
    //   56	18	5	localObject3	Object
    //   60	18	6	localObject4	Object
    //   46	1	7	localIOException	IOException
    //   25	3	8	localOutputStream	java.io.OutputStream
    //   70	6	9	localObject5	Object
    // Exception table:
    //   from	to	target	type
  ...
  static java.net.URI getRedirectedUri(Context paramContext, java.net.URI paramURI)
  {
    ...
    //   32: invokevirtual 117	com/facebook/internal/FileLruCache:get	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/InputStream;
    //   35: astore 14
    //   37: aload 14
    //   39: ifnull +96 -> 135
    //   42: new 119	java/io/InputStreamReader
    //   45: dup
    //   46: aload 14
    //   48: invokespecial 122	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   51: astore 5
    //   53: sipush 128
    //   56: newarray char
    //   58: astore 17
    ...
    //   74: aload 17
    //   76: arraylength
    //   77: invokevirtual 126	java/io/InputStreamReader:read	([CII)I
    //   80: istore 19
    //   82: iload 19
    //   84: ifle +26 -> 110
    //   87: aload 18
    ...
    //   91: iconst_0
    //   92: iload 19
    //   94: invokevirtual 129	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   97: pop
    //   98: goto -29 -> 69
    //   101: astore 16
    //   103: aload 5
    ...
    //   142: dup
    //   143: aload 10
    //   145: invokespecial 130	java/net/URI:<init>	(Ljava/lang/String;)V
    //   148: astore 22
    //   150: aload 11
    ...
    //   0	239	1	paramURI	java.net.URI
    //   1	135	2	i	int
    //   12	8	3	str1	String
    //   222	1	4	localURISyntaxException1	java.net.URISyntaxException
    //   51	184	5	localObject1	Object
    //   177	6	6	localObject2	Object
    //   184	8	7	localObject3	Object
    //   194	1	7	localObject4	Object
    //   199	1	7	localObject5	Object
    //   165	1	8	localIOException1	IOException
    //   17	9	9	localFileLruCache	FileLruCache
    //   20	124	10	localObject6	Object
    //   23	210	11	localObject7	Object
    //   230	1	12	localURISyntaxException2	java.net.URISyntaxException
    //   213	1	13	localIOException2	IOException
    //   35	12	14	localInputStream	java.io.InputStream
    //   208	1	15	localIOException3	IOException
    //   101	1	16	localURISyntaxException3	java.net.URISyntaxException
    //   58	32	17	arrayOfChar	char[]
    //   67	49	18	localStringBuilder	java.lang.StringBuilder
    //   80	13	19	j	int
    //   120	3	21	str2	String
    //   148	8	22	localURI	java.net.URI
    // Exception table:
    //   from	to	target	type
