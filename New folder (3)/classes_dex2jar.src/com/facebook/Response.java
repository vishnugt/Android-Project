...
public class Response
{
  ...
  static List<Response> fromHttpConnection(HttpURLConnection paramHttpURLConnection, RequestBatch paramRequestBatch)
  {
    ...
    //   0	512	0	paramHttpURLConnection	HttpURLConnection
    //   0	512	1	paramRequestBatch	RequestBatch
    //   1	482	2	localObject1	Object
    //   126	377	3	localFileLruCache1	FileLruCache
    //   132	373	4	localObject2	Object
    //   136	372	5	localObject3	Object
    //   470	8	6	localObject4	Object
    //   424	29	7	localSecurityException	java.lang.SecurityException
    //   460	8	8	localList1	List
    //   378	29	9	localIOException1	IOException
    //   414	8	10	localList2	List
    //   332	29	11	localJSONException1	JSONException
    //   368	8	12	localList3	List
    //   293	25	13	localFacebookException1	FacebookException
    //   322	8	14	localList4	List
    //   279	8	15	localInputStream1	InputStream
    //   162	8	16	localList5	List
    //   13	41	17	localCacheableRequestBatch	com.facebook.internal.CacheableRequestBatch
    //   18	471	18	localFileLruCache2	FileLruCache
    //   25	467	19	str1	String
    //   242	7	20	localObject5	Object
    //   219	1	21	localIOException2	IOException
    //   230	6	22	str2	String
    //   196	1	23	localJSONException2	JSONException
    //   207	6	24	str3	String
    //   172	1	25	localFacebookException2	FacebookException
    //   175	309	26	localObject6	Object
    //   81	3	27	localInputStream2	InputStream
    //   129	6	28	str4	String
    //   480	1	29	localFacebookException3	FacebookException
    //   97	7	30	localList6	List
    // Exception table:
    //   from	to	target	type
